...
import Aux
    from "../../../hoc/_Aux";
import Card
    from "../../../App/components/MainCard";
import UcFirst
    from "../../../App/components/UcFirst";
    ...
    render() {
        ...
        const outlineButtons = buttonVariants.map((variant, idx) => (
            <OverlayTrigger
                key={idx}
                overlay={
                    <Tooltip>{'outline-' + variant}</Tooltip>}>
                <Button
                    variant={'outline-' + variant}><UcFirst
                    text={variant}/></Button>
            </OverlayTrigger>
        ));
        ...
        const basicDropdownButton = buttonOptions.map(
            button => {
                ...
                return (
                    ...
                    >
                        <Dropdown.Item
                            eventKey="1">Action</Dropdown.Item>
                        <Dropdown.Item
                            eventKey="2">Another
                            action</Dropdown.Item>
                        <Dropdown.Item
                            eventKey="3">Something
                            else
                            hear</Dropdown.Item>
                    </DropdownButton>
                );
            ...
            <Aux>
                <Row>
                    <Col>
                        <Card
                            title="Default">
                            <p>use <code>variant="*"</code> props
                                in
                                component <code>Button</code> to
                                get
                                various
                                button
                            </p>
                        ...
                        <Card
                            title="Outline">
                            <p>use <code>variant="outline-*"</code> props
                                in
                                component <code>Button</code> to
                                get
                                various
                        ...
                        <Card
                            title="Square Button">
                            <p>use <code>className="btn-square"</code> props
                                in
                                component <code>Button</code> to
                                get
                                square
