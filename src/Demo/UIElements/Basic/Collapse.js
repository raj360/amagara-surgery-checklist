                ...
                <Row>
                        ...
                        <Card>
                            <Card.Header>
                                <Button
                                    ...
                                    aria-expanded={isBasic}>Collapse
                                    Link</Button>
                                <Button
                                    onClick={() => this.setState({isBasic: !isBasic})}>Collapse
                                    Button</Button>
                            </Card.Header>
                            <Collapse
                    ...
                    <Col
                        ...
                        <Button
                            ...
                            aria-expanded={isMultiTarget.some(target => target === 'target1')}>Toggle
                            first
                            element</Button>
                        <Button
                            onClick={() => this.targetHandler('target2')}
                            aria-controls="target2"
                            aria-expanded={isMultiTarget.some(target => target === 'target2')}>Toggle
                            second
                            element</Button>
                        <Button
                            onClick={this.multiTargetHandler}>Toggle
                            both
                            elements</Button>
                        <Row>
                            <Col>
